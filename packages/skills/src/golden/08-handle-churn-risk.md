...
Step 2: Use `get_ticket` on any tickets referencing cancellation, competitor, or dissatisfaction to read the full context.
Step 3: Use `get_call` on the most recent call recording to understand their current sentiment and stated pain points.
