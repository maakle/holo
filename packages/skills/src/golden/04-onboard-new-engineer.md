...
Step 1: Use `get_doc` to pull the latest onboarding checklist from Notion (search for "Engineering Onboarding Checklist").
...
Step 6: Use `get_thread` on the last team planning thread to give context on current sprint priorities.
