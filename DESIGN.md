...
## Product Context
- **What this is:** Open-source, self-hostable MCP context layer for AI agents. Community Edition is AGPL-3.0; Enterprise Edition (collaboration, SSO, RBAC, analytics, query history, custom code, whitelabeling) is commercial — see [`LICENSING.md`](./LICENSING.md).
