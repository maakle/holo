...
>
> **Self-host on day one.** If `docker compose up` doesn't work, it doesn't ship. AGPL-3.0. There's no managed cloud yet — that lives behind v0.2 demand.
>
> **Quickstart:**
>
> ```
...
**"Why AGPL-3.0?"**
> Same reason Mongo and Plausible used it — keeps a managed-cloud path open for us without killing OSS adoption. If you want to wrap holo in a commercial offering, talk to me.
