...
- The full design doc lives in `~/.gstack/projects/maakle-memex/maakle-main-design-20260429-095039.md` (private, generated by `/office-hours`). It contains the v0.0 connector priority order, MCP tool surface, success criteria, kill-switch logic, and the reasoning chain that produced this ADR.
