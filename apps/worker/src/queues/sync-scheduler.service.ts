...
export class SyncSchedulerService implements OnModuleInit {
  ...
  constructor(
    ...
    @InjectQueue(QUEUE_NAMES.PRISMIC_SYNC) prismic: Queue,
    @InjectQueue(QUEUE_NAMES.ZENDESK_SYNC) zendesk: Queue,
    @InjectQueue(QUEUE_NAMES.WEBCRAWL_SYNC) webcrawl: Queue,
    ...
    this.queueMap = {
      ...
      prismic: [QUEUE_NAMES.PRISMIC_SYNC],
      zendesk: [QUEUE_NAMES.ZENDESK_SYNC],
      webcrawl: [QUEUE_NAMES.WEBCRAWL_SYNC],
    ...
    this.queuesByName = {
      ...
      [QUEUE_NAMES.PRISMIC_SYNC]: prismic,
      [QUEUE_NAMES.ZENDESK_SYNC]: zendesk,
      [QUEUE_NAMES.WEBCRAWL_SYNC]: webcrawl,
