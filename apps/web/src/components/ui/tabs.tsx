...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'relative inline-flex h-10 items-center whitespace-nowrap px-3 text-[13px] font-medium text-text-muted',
      'transition-colors duration-micro ease-enter',
      'hover:text-text',
      'focus-visible:outline-hidden focus-visible:text-text',
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      'mt-6 focus-visible:outline-hidden',
      className,
    )}
    {...props}
  />
